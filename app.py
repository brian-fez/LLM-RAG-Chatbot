    ...
    with col2:
        ...
        if create_embeddings:
            if st.session_state['temp_pdf_path'] is None:
                ...
                try:
                    # Initialize the EmbeddingsManager without Qdrant
                    ...
                    with st.spinner("🔄 Embeddings are in process..."):
                        # Create embeddings (stores FAISS in memory)
                    ...
                    chatbot.set_vector_store(embeddings_manager.vector_store)

                    # Store chatbot in session
